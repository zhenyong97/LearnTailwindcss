            ...
            <div className='flex w-[700px] mx-auto mt-10 flex-col justify-center items-center gap-5'>
                ...
                <div className='flex'>
                    <div className='w-[550px] relative'>
                        <input type="text" className='w-full rounded-l-xl focus:border-indigo-400 border-r-none rounded-r-none border h-[43px] overflow-hidden border-gray-300' />
                        
                        <div className='absolute inset-y-2 right-2 text-blue-600'>
                            <CameraLogo className='w-[24px] h-[24px] cursor-pointer fill-current' />
